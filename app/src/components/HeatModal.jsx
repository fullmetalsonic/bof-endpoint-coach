    ...
    <div className="modal-backdrop" role="presentation">
      <form className="event-modal heat-modal" onSubmit={submit} role="dialog" aria-modal="true" aria-labelledby="heat-modal-title">
        ...
        <div className="form-grid">
          ...
          <label><span>{t("expectedDuration")} (min)</span><input type="number" min="1" value={form.expectedDurationMinutes} onChange={(event) => set("expectedDurationMinutes", event.target.value)} required /></label>
        </div>
        ...
        <div className="form-grid heat-input-grid">
          ...
          <label><span>{t("initialFlux")} (kg)</span><input type="number" min="0" value={form.fluxKg} onChange={(event) => set("fluxKg", event.target.value)} required /></label>
          <label><span>{t("plannedOxygen")} (Nm³)</span><input type="number" min="0" value={form.plannedTotalOxygenNm3} onChange={(event) => set("plannedTotalOxygenNm3", event.target.value)} required /></label>
          ...
          <label><span>{t("lanceHeight")} (m)</span><input type="number" min="0" step="0.1" value={form.lanceHeightM} onChange={(event) => set("lanceHeightM", event.target.value)} required /></label>
          <label><span>{t("oxygenFlow")} (Nm³/min)</span><input type="number" min="0" value={form.oxygenFlowNm3PerMinute} onChange={(event) => set("oxygenFlowNm3PerMinute", event.target.value)} required /></label>
        </div>
