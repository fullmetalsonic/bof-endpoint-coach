...
export function SettingsScreen({ settings, heats, trainingRuns = [], locale, t, operatorName, onSave, onDirtyChange, canWrite = true, coefficientCandidate, onCandidateConsumed, recoveryCardRequested = false, onRecoveryCardRequestHandled }) {
  const [tab, setTab] = useState(recoveryCardRequested ? "coefficients" : "grades");
