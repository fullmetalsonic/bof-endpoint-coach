...
export function SettingsScreen({ settings, heats, locale, t, operatorName, onSave, onDirtyChange, canWrite = true, coefficientCandidate, onCandidateConsumed }) {
    ...
    <main className="workspace-screen settings-screen" data-testid="settings-screen">
      ...
      <div className="settings-layout">
        ...
        <section className="settings-content panel">
          ...
          {tab === "coefficients" && <CoefficientProfilesEditor draft={draft} setDraft={setDraft} locale={locale} candidate={coefficientCandidate} />}
