...
- 구현 커밋: `132c52a`
- GitHub Actions CI `32576080462`: lint, test, build, single build, Sites test 전체 PASS
- 정식 Release: `https://github.com/fullmetalsonic/bof-endpoint-coach/releases/tag/v0.2.1`
- 실행 HTML: 507,096바이트, SHA-256 `A00A1DB63D87BE8F9B62D244EA0BAF061CB2E0043CDB36786DF264A0D2E8CC81`
- 사용 설명서: 707,151바이트, SHA-256 `1743F3C6D59F83A616524FFE89C0D36A5F8AE17EBF8909040812016396613E0C`
- Release 자산 digest와 로컬 SHA-256이 모두 일치했다.
- 최신 원격 README로 GitHub형 오프라인 README와 CID 메일 본문을 생성했다.
- 1280×960·720×960 메일 미리보기에서 이미지 3장 로드, v0.2.1·Release 링크 표시, 가로 넘침·페이지 오류 없음.
- 전송 메일은 `SENT`, `multipart/mixed → multipart/related → multipart/alternative` 구조이며 CID 이미지 3장과 실행 HTML·사용 설명서·README HTML 첨부 3개의 파일명·크기를 보낸편지함에서 확인했다. 주소와 메시지 ID는 공개 기록에서 제외했다.
